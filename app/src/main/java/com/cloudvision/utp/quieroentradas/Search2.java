...
public class Search2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    private static final String TAG = "Search2";
    private static final int RECORD_REQUEST_CODE = 101;
    private static final int CAMERA_REQUEST_CODE = 102;
    private static final String CLOUD_VISION_API_KEY = "AIzaSyDv0nRvPmzDpTZayTKW9jLiQvaWl6AvKOc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerVisionAPI =(Spinner) findViewById(R.id.spinnerVisionAPI);
    ...
    private String getWebDetection(WebDetection webDetection) {
        String message = "";
